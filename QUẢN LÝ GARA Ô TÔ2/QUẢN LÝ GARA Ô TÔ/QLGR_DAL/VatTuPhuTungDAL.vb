...
Public Class VatTuPhuTungDAL
    ...
    Public Function insert(phuTung As VatTuPhuTungDTO) As Result
        ...
        Dim query As String = String.Empty
        query &= "INSERT INTO [tblVatTuPhuTung] ([MaLoaiPhuTung], [TenLoaiPhuTung], [DonGia], [SoLuong], [NgayNhap])"
        query &= "VALUES (@MaLoaiPhuTung,@TenLoaiPhuTung,@DonGia,@SoLuong,@NgayNhap)"
        ...
        Using conn As New SqlConnection(connectionString)
            Using comm As New SqlCommand()
                With comm
                    ...
                    .Parameters.AddWithValue("@NgayNhap", phuTung.NgayNhap)
                End With
                Try
                    conn.Open()
    ...
    Public Function selectALL(ByRef listPhuTung As List(Of VatTuPhuTungDTO)) As Result
        ...
        Dim query As String = String.Empty
        query &= " SELECT [MaLoaiPhuTung], [TenLoaiPhuTung], [DonGia], [SoLuong], [NgayNhap]"
        query &= " FROM [tblVatTuPhuTung]"
            ...
            Using comm As New SqlCommand()
                ...
                Try
                    ...
                    If reader.HasRows = True Then
                        listPhuTung.Clear()
                        While reader.Read()
                            listPhuTung.Add(New VatTuPhuTungDTO(reader("MaLoaiPhuTung"), reader("TenLoaiPhuTung"), reader("DonGia"), reader("SoLuong"), reader("NgayNhap")))
                        End While
                    End If
                Catch ex As Exception
                    Console.WriteLine(ex.StackTrace)
