...
Public Class CrystalRPBAOCAODT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QLGR_GUI.CrystalRPBAOCAODT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalRPBAOCAODT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalRPBAOCAODT = New CrystalRPBAOCAODT()
        rpt.Site = Me.Site
        Return rpt
    End Function
