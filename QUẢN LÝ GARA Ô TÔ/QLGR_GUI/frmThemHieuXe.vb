...
Public Class frmThemHieuXe
    ...
    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        ...
        If (LoaiHieuXe_BUS.isValidID(HieuXe_DTO) = False) Then
            MessageBox.Show("Mã Loại hiệu xe không đúng. Vui lòng kiểm tra lại", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtMaHieuXe.Focus()
            Return
        End If
