...
Public Class frmThemVatTuPhuTung
    ...
    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        ...
        phuTung.NgayNhap = dtpNgayNhap.Value
        ...
        If (phuTungBus.isValidID(phuTung) = False) Then
            MessageBox.Show("Mã Loại phụ tùng không đúng. Vui lòng kiểm tra lại", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtTenLoaiPhuTung.Focus()
            Return
        End If
