...
Public Class VatTuPhuTungBUS
    ...
    Public Function isValidID(phuTung As VatTuPhuTungDTO) As Boolean

        If (phuTung.MaLoaiPhuTung.ToString().Length() < 1) Then
            Return False
        End If
    ...
    Public Sub updateList(listVatTuPhuTung As List(Of VatTuPhuTungDTO))
        For Each vatTu In listVatTuPhuTung
            update(vatTu)
        Next
    End Sub
End Class
